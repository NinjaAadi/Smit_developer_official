...
exports.UnfollowUser = async (req,res,next) => {
  try {
        ...
        profile.followers = profile.followers.filter(user => user.user.toString()!=req.user._id.toString());
        
        userprofile.following = userprofile.following.filter(user => user.user.toString()!=useridtounfollow.toString())
